...
![DNS1](https://github.com/webcodingnpc/one_click_script/blob/master/docs/dns1.png?raw=true)

2. 早些年网页采用http方式传输, 网页没有加密. 后来基于TLS加密技术的https方式传送,网页就被加密无法看到传送的内容了. 如下图
![DNS2](https://github.com/webcodingnpc/one_click_script/blob/master/docs/dns2.png?raw=true)

3. 网页传输 http未加密 与 https加密 对比图. 可以看到内容已被加密
![HTTPS1](https://github.com/webcodingnpc/one_click_script/blob/master/docs/https1.png?raw=true)
...
![DNS3](https://github.com/webcodingnpc/one_click_script/blob/master/docs/dns3.png?raw=true)
...
![Chrome1](https://github.com/webcodingnpc/one_click_script/blob/master/docs/chrome1.png?raw=true)
![Chrome2](https://github.com/webcodingnpc/one_click_script/blob/master/docs/chrome2.png?raw=true)
...
![Chrome3](https://github.com/webcodingnpc/one_click_script/blob/master/docs/chrome3.png?raw=true)
...
![Firefox1](https://github.com/webcodingnpc/one_click_script/blob/master/docs/firefox1.png?raw=true)
![Firefox2](https://github.com/webcodingnpc/one_click_script/blob/master/docs/firefox2.png?raw=true)

3. 在打开的对话框中，在最下面, 选中 "启用基于 HTTPS 的 DNS", 然后在下拉框可以选择Cloudflare 默认值或自定义的DOT服务器 .  [如何验证是否开启DOT和ESNI](#测试是否开启DOT和ESNI ).
![Firefox3](https://github.com/webcodingnpc/one_click_script/blob/master/docs/firefox3.png?raw=true)
...
![Firefox1](https://github.com/webcodingnpc/one_click_script/blob/master/docs/firefoxesni1.png?raw=true)
![Firefox2](https://github.com/webcodingnpc/one_click_script/blob/master/docs/firefoxesni2.png?raw=true)

3. 然后选择 "布尔" 类型, 点击右边 + 号, 然后点击右边按钮 将值设为true, 完成.  [如何验证是否开启DOT和ESNI](#测试是否开启DOT和ESNI ).
![Firefox3](https://github.com/webcodingnpc/one_click_script/blob/master/docs/firefoxesni3.png?raw=true)
...
![CF1](https://github.com/webcodingnpc/one_click_script/blob/master/docs/cfcheck1.png?raw=true)

2. 查看结果. 目前Chrome 还不支持ESNI,估计很快就会支持.
![CF2](https://github.com/webcodingnpc/one_click_script/blob/master/docs/cfcheck2.png?raw=true)
...
![CF3](https://github.com/webcodingnpc/one_click_script/blob/master/docs/cfcheck3.png?raw=true)

### AdGuardHome
### 搭建的DNS服务器

1. 通过本脚本, ``` bash <(curl -Lso- https://raw.githubusercontent.com/webcodingnpc/one_click_script/master/trojan_v2ray_install.sh) ``` 运行本脚本, 选择28 安装 AdGuard Home 架设DNS服务器, 同时还可以去广告. 建议在国外的服务器上安装
...
```bash
wget --no-check-certificate https://raw.githubusercontent.com/webcodingnpc/one_click_script/master/dsm/openwrt.sh && chmod +x ./openwrt.sh && ./openwrt.sh
```
...
![mosdns1](https://github.com/webcodingnpc/one_click_script/blob/master/docs/mosdns1.png?raw=true)
...
![mosdns2](https://github.com/webcodingnpc/one_click_script/blob/master/docs/mosdns2.png?raw=true)
![mosdns3](https://github.com/webcodingnpc/one_click_script/blob/master/docs/mosdns3.png?raw=true)
...
![mosdns4](https://github.com/webcodingnpc/one_click_script/blob/master/docs/mosdns4.png?raw=true)
...
![mosdns6](https://github.com/webcodingnpc/one_click_script/blob/master/docs/mosdns6.png?raw=true)
...
![mosdns5](https://github.com/webcodingnpc/one_click_script/blob/master/docs/mosdns5.png?raw=true)
